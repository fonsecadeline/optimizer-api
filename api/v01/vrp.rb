  ...
  module V01
    ...
    class Vrp < APIBase
      ...
      def self.vrp_request_vehicle(this)
        ...
        this.optional(:overall_duration, types: [String, Float, Integer], documentation: { hidden: true }, desc: '[Non-functional][planning] If schedule covers several days, maximum work duration over whole period. Not available with periodic heuristic.', coerce_with: ->(value) { ScheduleType.new.type_cast(value, false, false) })
