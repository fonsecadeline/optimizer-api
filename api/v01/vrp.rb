  ...
  module V01
    ...
    class Vrp < APIBase
      ...
      def self.vrp_request_resolution(this)
        ...
        this.optional(:minimize_used_days, type: Boolean, default: false, desc: '(Scheduling heuristic only) Tries to fill minimum possible days. Starts filling sooner days.')
